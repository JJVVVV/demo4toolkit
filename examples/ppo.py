...
from trl import ModelConfig, PPOConfig, PPOTrainer, ScriptArguments, get_kbit_device_map, get_peft_config, get_quantization_config
...
if __name__ == "__main__":
    ...
    print(model_args.model_name_or_path, training_args.sft_model_path, training_args.reward_model_path)
    ...
    if peft_config is None:
        ref_policy = AutoModelForCausalLM.from_pretrained(training_args.sft_model_path, trust_remote_code=model_args.trust_remote_code)
    else:
        ref_policy = None
